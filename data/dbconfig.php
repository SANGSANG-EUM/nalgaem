...
define('G5_MYSQL_USER', 'db_nalgaem');
define('G5_MYSQL_PASSWORD', 'buster@4868##');
define('G5_MYSQL_DB', 'db_nalgaem');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'iium_');

define('G5_TOKEN_ENCRYPTION_KEY', '21533a358209c5a50ce28136e5265d4d'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 'iium_shop_');
