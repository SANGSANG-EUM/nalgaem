          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide live-slide">
              <div class="live-sl-video">
                <img src="https://img.youtube.com/vi/MljpuzHfXWw/sddefault.jpg" alt="" class="live-sl-thumb"></img>
                <iframe src="https://www.youtube.com/embed/MljpuzHfXWw?si=-ppSWAigKFswswe0?enablejsapi=1"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  allowfullscreen></iframe>
                <button type="button" class="live-fav-btn"><span class="sound_only">즐겨찾기</span></button>
      ...
      <div class="mainsec mainsec-3">
        ...
        <script>
          function playYouTubeVideo() {
            ...
            // Set the source URL to the YouTube video
            youtubeIframe.src = "https://www.youtube.com/embed/MljpuzHfXWw?si=-ppSWAigKFswswe0&autoplay=1";
          }

          function liveBtn() {
            // Your code for the "즐겨찾기" button click event here
          }
        </script>
        <div class="notice-wr">
          <div class="wrapper">
            ...
            <div class="main-sl-ctr-wr notice-sl-ctr-wr">
              ...
              <div class="main-sl-in-wr">
                ...
                <button type="button" type="button" class="main-sl-btn notice-sl-btn pause"
                  title="공지사항 슬라이드 멈춤"></button>
              </div>
