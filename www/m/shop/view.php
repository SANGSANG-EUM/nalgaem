...
if(!$gs['use_aff'] && $config['coupon_yes']) {
	...
	if($is_member)
		$cp_btn = "<a href=\"javascript:window.open('".BV_MSHOP_URL."/pop_coupon.php?gs_id=$gs_id','_blank');\" class=\"btn_ssmall bx-blue\">쿠폰다운로드</a>";
	else
...
$sns_share_links .= get_sns_share_link('kakaotalk', $sns_url, $sns_title, BV_IMG_URL.'/sns/kakaotalk.gif');
