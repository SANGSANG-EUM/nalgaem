...
<div class="s_cont">
	...
	<div class="fregister_agree">
		<h3 class="fr_tit">
			회원가입 약관 (필수)
			<a href="<?php echo BV_MBBS_URL; ?>/provision.php" target="_blank" class="btn_small bx-white">전문보기</a>
		</h3>
	...
	<div class="fregister_agree">
		<h3 class="fr_tit">
			개인정보 수집 및 이용 (필수)
			<a href="<?php echo BV_MBBS_URL; ?>/policy.php" target="_blank" class="btn_small bx-white">전문보기</a>
		</h3>
