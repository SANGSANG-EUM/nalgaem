...
<div class="mb_login">
	...
	<section class="login_fs">
		...
		<p class="mart3"><a href="<?php echo BV_MBBS_URL; ?>/register.php" class="btn_medium wfull bx-white">회원가입</a></p>
	...
	<section class="mb_login_od">
		<h3>비회원 구매</h3>
		<p class="mart15"><a href="<?php echo BV_MSHOP_URL; ?>/orderform.php" class="btn_medium wfull red">비회원으로 구매하기</a></p>
	</section>
