...
<div class="pr_slide" id="type5">
	<?php echo mobile_slide_goods('1', '20', $default['de_pname_1'], 'slider'); ?>
	<script>
    $(document).on('ready', function() {
      $("#type5 .slider").slick({
		autoplay: true,
...
<!-- 베스트셀러 시작 {-->
<div class="mart30">
	<?php echo mobile_display_goods('2', '6', $default['de_pname_2'], 'pr_desc wli2'); ?>
</div>
<!-- } 베스트셀러 끝 -->
...
<!-- 추천상품 시작 { -->
<div class="mart30">
	<?php echo mobile_display_goods('5', '6', $default['de_pname_5'], 'pr_desc wli2'); ?>
</div>
<!-- } 추천상품 끝 -->
