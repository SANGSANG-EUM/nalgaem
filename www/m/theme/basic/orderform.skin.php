...
<div id="sod_frm">
	...
	<section id="sod_frm_pay">
		...
		<div class="odf_tbl">
			...
			<tr>
				...
				<td>
					<span id="dc_coupon"><a href="javascript:window.open('<?php echo BV_MSHOP_URL; ?>/ordercoupon.php');" class="btn_small bx-red">사용 가능 쿠폰 <?php echo $sp_count[3]; ?>장</a>&nbsp;</span>(-)&nbsp;&nbsp;<strong><span id="dc_amt">0</strong>원&nbsp;<span id="dc_cancel" style="display:none;"><a href="javascript:coupon_cancel();" class="btn_small grey">삭제</a></span></span>
				</td>
			</tr>
			<?php } ?>
			<?php
	...
	<div class="btn_confirm">
		...
		<a href="<?php echo BV_MSHOP_URL; ?>/cart.php" class="btn_medium bx-white">주문취소</a>
	</div>
</div>
</form>
