...
<div class="subwr read">
	<div class="nalgaem-read-wr">
		<div class="nalgaem-read-in">
		<div class="nalgaem-read-subj-wr">
		...
		<?php if($bo_file1) { ?>
		<ul class="nalgaem-read-file-ul">
			<li class="nalgaem-read-file-li">첨부파일1 : <a href="./download.php?file=<?php echo $bo_file1; ?>&url=<?php echo BV_DATA_PATH; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>"><b><?php echo $bo_file1; ?></b></a></il>
		<?php } ?>
		<?php if($bo_file2) { ?>
			<li class="nalgaem-read-file-li">첨부파일2 : <a href="./download.php?file=<?php echo $bo_file2; ?>&url=<?php echo BV_DATA_PATH; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file2; ?>"><b><?php echo $bo_file2; ?></b></a></li>
		</ul>
		<?php } ?>
		<div class="nalgaem-read-content-wr">
			<div class="nalgaem-read-content">
			<?php
	...
	<!-- <div class="page_wrap">
		...
		<div class="rbt_box">
			...
			<a href="./modify.php?<?php //echo $qstr2; ?>" class="btn_large bx-white">수정</a>
			<?php //} ?>
			<?php //if($member['index_no'] && $member['grade']<=$board['reply_priv'] && $board['usereply']=='Y') { ?>
			<a href="./reply.php?<?php //echo $qstr2; ?>" class="btn_large bx-white">답글</a>
			<?php //} ?>
			<?php //if(($member['index_no'] == $bo_writer) || is_admin()) { ?>
			<a href="./del.php?<?php //echo $qstr2; ?>" class="btn_large bx-white">삭제</a>
			<?php //} ?>
...
<div class="nalgaem-btn-list-wr"><a href="./list.php?<?php echo $qstr1; ?>" class="nalgaem-btn-list"><img src="/source/img/icon-list.png" alt="">목록보기</a></div>
