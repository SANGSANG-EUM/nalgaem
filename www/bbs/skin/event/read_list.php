...
<div class="read-list-wr">
	...
	?>
	<li class="read-list-li prev">
		<!-- <th width="15%">▲ 이전 글</th> -->
		<a href="<?php echo $prev_href ?>"><span class="read-list-guide prev"><img src="/source/img/icon-read_prev.png" alt="">이전글</span><span class="read-list-subject"><?php echo $prev_subject; ?></span> <?php //echo $prev_tailcount; ?></a>
	</li>
	<?php
	}
	...
	?>
	<li class="read-list-li next">
		<!-- <th width="15%">▼ 다음 글</th> -->
		<a href="<?php echo $next_href ?>"><span class="read-list-subject"><?php echo $next_subject; ?></span> <?php //echo $next_tailcount; ?> <span class="read-list-guide next">다음글<img src="/source/img/icon-read_next.png" alt=""></span></a>
	</li>
	<?php } ?>
	</ul>
</div>
